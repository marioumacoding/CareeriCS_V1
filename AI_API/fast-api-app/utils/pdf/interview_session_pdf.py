...
def build_session_report_pdf(db: Session, session_id: int, user_id: str):
    ...
    for item in summaries:
        elements.append(Paragraph(f"Question {item.get('question_number')}: {item.get('question_text')}", label_style))
