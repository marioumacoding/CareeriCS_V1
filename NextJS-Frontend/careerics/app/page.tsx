...
>
  ...
  />
        ...
        <div style={{ gridColumn: "2 / 3", gridRow: "1 / 3", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" , height: 200}}>
          <Image src="/landing/CV Builder Card.svg" alt="CV Builder" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 60, paddingLeft: 10, paddingRight: 10}}>
        ...
        <div style={{ gridColumn: "3 / 5", gridRow: "1 / 2", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" }}>
          <Image src="/landing/CV Enhancer Card.svg" alt="CV Enhancer" fill style={{ objectFit: "cover" }} />
        ...
        <div style={{ gridColumn: "1 / 2", gridRow: "2 / 4", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32", height: 400 }}>
          <Image src="/landing/Roadmap Card.svg" alt="Roadmap Generation" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: 16 }}>
        ...
        <div style={{ gridColumn: "2 / 3", gridRow: "2 / 3", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" }}>
          <Image src="/landing/Courses Card.svg" alt="Courses" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: 16 }}>
        ...
        <div style={{ gridColumn: "3 / 4", gridRow: "2 / 3", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" }}>
          <Image src="/landing/Interview Card.svg" alt="HR Interview" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: 16 }}>
        ...
        <div style={{ gridColumn: "4 / 5", gridRow: "2 / 4", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" }}>
          <Image src="/landing/Job Applicator Card.svg" alt="Job Applicator" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-start", padding: 16 }}>
        ...
        <div style={{ gridColumn: "2 / 3", gridRow: "3 / 4", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" }}>
          <Image src="/landing/Skill Assessment Card.svg" alt="Skill Assessment" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: 16 }}>
        ...
        <div style={{ gridColumn: "3 / 4", gridRow: "3 / 4", position: "relative", borderRadius: 14, overflow: "hidden", backgroundColor: "#0f1d32" }}>
          <Image src="/landing/Interview Card.svg" alt="Tech Interview" fill style={{ objectFit: "cover" }} />
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: 16 }}>
